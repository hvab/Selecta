...
**Текущая база:** Выпущена версия `0.6.0` (включая контраст, сохранение сессии, пресеты, JSON-экспорт, URL state и Google Fonts).
...
Этап 12 полностью завершён. Следующий: **этап 13+** (контракт темы, версии Aegea, глубокое превью).
