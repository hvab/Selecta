...
- [ ] Choose the next post-`0.6.0` slice: release cleanup or Stage 13+ theme contract expansion.
...
- [x] Stage 12.4: Flat font select with Plain, system groups, and Google category groups from a curated Cyrillic catalog.
